...
with st.container(border=True):
    ...
    with col_mode:
        ...
        # Use visually distinct options with emojis
        ...
        # Strip the emoji to keep your internal app logic identical
        ...
        # Dynamic Helper Text so the team knows exactly what will happen
